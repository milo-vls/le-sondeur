...
load_title_screen ()
{
        ...
        // play button
        Sprite play_button_sprite = create_sprite_auto_h_animation (
            LoadTexture ("ressources/buttons/jouer/jouer_ss.png"), 3, 3);
        Sprite hovered_play_button_sprite = create_sprite_auto_h_animation (
            LoadTexture ("ressources/buttons/jouer/jouer_alt_ss.png"), 3, 3);
        Vector2 play_button_position
            = { .x = (float)TITLE_SCREEN_PLAY_BUTTON_X_POS,
                .y = (float)TITLE_SCREEN_QUIT_BUTTON_Y_POS };
        Button play_button
            = (Button){ .position = play_button_position,
